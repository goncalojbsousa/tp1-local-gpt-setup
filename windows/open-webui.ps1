# Open WebUI em http://localhost:3001 (Windows)
# corre no PowerShell: irm https://raw.githubusercontent.com/goncalojbsousa/tp1-local-gpt-setup/main/windows/open-webui.ps1 | iex
& {
$Script = "open-webui"
...
$Port = 3001
$Model = "qwen3.5:4b"
$Host_ = "http://host.docker.internal:11434"
...
Ensure-Container $Name @(
    ...
    "-e", "OLLAMA_BASE_URL=$Host_",
    "-e", "RAG_EMBEDDING_ENGINE=ollama",
    "-e", "RAG_EMBEDDING_MODEL=mxbai-embed-large",
    "-e", "RAG_OLLAMA_BASE_URL=$Host_",
    "-v", "open-webui:/app/backend/data",
    "ghcr.io/open-webui/open-webui:main"
)

Write-Host "Na primeira vez cria uma conta local (o primeiro utilizador é o admin)"
Open-WhenReady "http://localhost:$Port" 240
} finally {
